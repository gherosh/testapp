...
<div class="block">
    ...
    <table width="100%" bgcolor="#f6f4f5" cellpadding="0" cellspacing="0" border="0" id="backgroundTable"
        ...
        <tr>
            <td>
                <table width="580" bgcolor="#004cad" cellpadding="0" cellspacing="0" border="0" align="center"
                            ...
                            <table width="280" cellpadding="0" cellspacing="0" border="0" align="left"
                                ...
                                <tr>
                                    <td valign="middle" width="270" style="padding: 10px 0 10px 20px;" class="logo">
                                        <div class="imgpop">
                                            <a href="#"><img
                                                    src="https://via.placeholder.com/120x80.png/00eebb?text=Logo"
                                                    alt="logo" width="120" height="80" border="0"
                    ...
                    <tr>
                        <td>
                            <table width="540" align="center" cellspacing="0" cellpadding="0" border="0"
                                ...
                                <tr>
                                    <td class="paragraph">
                                        {{ \Illuminate\Support\Str::limit($article->content, 30, ' ...')  }} <a href="{{ env('APP_FRONT_URL') . '/article/' . $article->slug }}">read more</a>
                                    </td>
                                </tr>
                                <tr>
